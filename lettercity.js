(function (root, factory) {
  ...
  var loadDependence = function (fncallback) {
    ...
    if (!window.wwload.lettercity) {
      window.wwload.lettercity = "wait";
      // requirejs.config({
      //   paths: {
      //     "lettercity": "libs/lettercity/js/" // 示例: libs/qrcodejs/qrcode
      //   }
      // });
      require(["libs/lettercity/js/zepto", "libs/lettercity/js/city", "css!libs/lettercity/css/style"], function () {
        window.wwload.lettercity = true;
        replace();
        fncallback();
      });
    } else if (window.wwload.lettercity === "wait") {
      setTimeout(function () {
  ...
  var init = function () {
    ...
    // $("body").append('<div id="showLetter" class="showLetter"><span>A</span></div><div class="letter"><ul><li><a href="javascript:;">热门</a></li><li><a href="javascript:;">历史</a></li><li><a href="javascript:;">A</a></li><li><a href="javascript:;">B</a></li><li><a href="javascript:;">C</a></li><li><a href="javascript:;">D</a></li><li><a href="javascript:;">E</a></li><li><a href="javascript:;">F</a></li><li><a href="javascript:;">G</a></li><li><a href="javascript:;">H</a></li><li><a href="javascript:;">J</a></li><li><a href="javascript:;">K</a></li><li><a href="javascript:;">L</a></li><li><a href="javascript:;">M</a></li><li><a href="javascript:;">N</a></li><li><a href="javascript:;">P</a></li><li><a href="javascript:;">Q</a></li><li><a href="javascript:;">R</a></li><li><a href="javascript:;">S</a></li><li><a href="javascript:;">T</a></li><li><a href="javascript:;">W</a></li><li><a href="javascript:;">X</a></li><li><a href="javascript:;">Y</a></li><li><a href="javascript:;">Z</a></li></ul></div>	');
    $("body").append('<div id="showLetter" class="showLetter"><span>A</span></div><div class="letter"><ul><li><a href="javascript:;">热</a></li><li><a href="javascript:;">A</a></li><li><a href="javascript:;">B</a></li><li><a href="javascript:;">C</a></li><li><a href="javascript:;">D</a></li><li><a href="javascript:;">E</a></li><li><a href="javascript:;">F</a></li><li><a href="javascript:;">G</a></li><li><a href="javascript:;">H</a></li><li><a href="javascript:;">J</a></li><li><a href="javascript:;">K</a></li><li><a href="javascript:;">L</a></li><li><a href="javascript:;">M</a></li><li><a href="javascript:;">N</a></li><li><a href="javascript:;">P</a></li><li><a href="javascript:;">Q</a></li><li><a href="javascript:;">R</a></li><li><a href="javascript:;">S</a></li><li><a href="javascript:;">T</a></li><li><a href="javascript:;">W</a></li><li><a href="javascript:;">X</a></li><li><a href="javascript:;">Y</a></li><li><a href="javascript:;">Z</a></li></ul></div>	');
  ...
  function lettercity_btn($ele) {
    ...
    $('body').on('click', '.city-list p', function () {
      ...
      saveHistory(data);
      //alert(data);
      $.wwclass.helper.updateProp($ele, "data-x-lettercity", data);

      var baseUrl = 'https://api.map.baidu.com/geocoder/v2/?ak=eIxDStjzbtH0WtU50gqdXYCz&output=json&address=' + data;
      ...
      $.ajax({
        ...
        success: function (data) {
          if (parseInt(data.status) == 0) {
            formdata.append("location", data.result.location);
            ...
            $.wwclass.helper.updateProp($ele, "data-x-lettercitylng", data.result.location.lng);
            $.wwclass.helper.updateProp($ele, "data-x-lettercitylat", data.result.location.lat);
            $.wwclass.helper.updateProp($ele, "data-x-lettercitypoint", JSON.stringify(data.result.location));
          }
        }
      })
    });

    $ele.find('.hot.hotCity').on('click', 'div', function () {
      var data = $(this).text();
      saveHistory(data);
      $.wwclass.helper.updateProp($ele, "data-x-lettercity", data);
      var baseUrl = 'https://api.map.baidu.com/geocoder/v2/?ak=eIxDStjzbtH0WtU50gqdXYCz&output=json&address=' + data;
    ...
    function bindHistoryClick() {
      $ele.find('.history .hot').on('click', 'div', function () {
        var data = $(this).text();
        saveHistory(data);
        $.wwclass.helper.updateProp($ele, "data-x-lettercity", data);
        var baseUrl = 'https://api.map.baidu.com/geocoder/v2/?ak=eIxDStjzbtH0WtU50gqdXYCz&output=json&address=' + data;
    ...
    function init() {
      ...
      $ele.find('.city').append(html);
    }

    // function initHistory() {  // 历史记录渲染
    //     var hotelHistory = localStorage.getItem('hotelHistory');
    //     var history = '';
    //     history += '<div class="tips" id="历史1">历史记录<div class="clear-history" >清空历史</div></div>';
    ...
    //     }
    //     history += '</div>';
    //     $ele.find('.history').html(history);
    //     bindHistoryClick();
    //     $ele.find('.clear-history').on('click', function () {
    //         clearHistory();
    //     });
    // }
    ; (function ($) {
  ...
  function processElement($ele) {
    ...
    setTimeout(function () {
      $.wwclass.helper.updateProp($ele, "data-x-inited", true);
      $ele.find(".city").removeClass("hidden");
    }, 100);
    lettercity_btn($ele);
